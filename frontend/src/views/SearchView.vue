        ...
        <div class="main-left col-span-3 space-y-4">
            <div class="bg-white border border-gray-200 rounded-lg">
                <div class="p-4 flex space-x-4">
                    ...
                    <a href="#" class="inline-blobk py-4 px-6 bg-purple-600 text-white rounded-lg">Post</a>
                </div>
            </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <p>This is a paragraph. This a random text.This is a paragraph. This a random text.This is a paragraph. This a random text.</p>
